...
<div id="filterMenu">
	...
	<?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=protected_links'.AMP.'method=memberstats'.AMP.'member_id='.$selected['member_id']);?>
...
<p><strong><?=$selected['screen_name']?></strong></p>
