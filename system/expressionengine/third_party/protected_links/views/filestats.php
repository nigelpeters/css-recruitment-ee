...
<li class="content_tab current"> <a href="<?=BASE.AMP.'C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=protected_links'.AMP.'method=files'?>"><?=lang('files')?></a>  </li> 
...
<div id="filterMenu">
	...
	<?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=protected_links'.AMP.'method=filestats'.AMP.'file_id='.$selected['file_id']);?>
...
<p><strong><?=$selected['url']?></strong></p>
