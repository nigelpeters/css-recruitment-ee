...
class Zoo_visitor_ext
{
	...
	function hook_sessions_end($SESS)
	{
		...
		if (isset($_GET['M']) && ($_GET['M'] == 'view_all_members')) {
		...
		if (isset($_GET['M']) && ($_GET['M'] == 'edit_profile')) {
		...
		if (isset($_GET['M']) && isset($_GET['C']) && $_GET['C'] == 'myaccount' && $_GET['M'] == 'member_preferences_update' && isset($_POST['group_id']) && isset($_POST['id'])) {
